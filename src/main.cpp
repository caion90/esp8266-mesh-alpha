...
int countTokens(const char *input, char delimiter)
{
  if (input == nullptr)
  {
    return 0;
...
int tokenize(char *input, char delimiter, char *tokens[], int maxTokens)
{
  if (input == nullptr || tokens == nullptr || maxTokens <= 0)
  {
    return 0;
  }
